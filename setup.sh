...
sed -i "s|isaac_install_path|$ISAAC_PATH|g" assets/turtlebot3_waffle_pi/urdf/turtlebot3_waffle_pi.urdf/
echo "Done."

echo "Changing paths in isaac.py"
sed -i "s|isaac_install_path|$ISAAC_PATH|g" isaac.py
echo "Done."